...
try {
    ...
    $mail->addAddress('ventas@gmail.com', $_SESSION["user"]);     // Add a recipient
    ...
    // Attachments
    $mail->addAttachment('../../json/ventas.json');         // Add attachments
    /*$mail->addAttachment('/tmp/image.jpg', 'new.jpg'); */    // Optional name

    // Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Nueva Venta';
    $mail->Body    = 'Una venta ha sido realizada por ' . $_SESSION["user"];
    /* $mail->AltBody = 'This is the body in plain text for non-HTML mail clients'; */

    $mail->send();
    
    echo "<h1>Su compra se ha realizado con éxito. Se le redirigirá al inicio en 5 segundos</h1>";
